...
os.system("python removeSpacesTag.py "+prob_name)
os.system("python renameVariablesTag.py "+prob_name)
os.system("python filterTag.py "+prob_name)
os.system("python mappingTag.py "+prob_name)
